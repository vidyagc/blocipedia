...
class ChargesController < ApplicationController
    ...
    def new
        if current_user.role == 'premium'
            ...
            @stripe_btn_data = { key: "#{ Rails.configuration.stripe[:publishable_key] }",
    ...
    def create
       ...
       flash[:notice] = "Thank you for your payment of #{view_context.number_to_currency(subscription.items['data'][0]['plan']['amount']/100)}, #{current_user.email}. You can begin creating private Wikis!"
